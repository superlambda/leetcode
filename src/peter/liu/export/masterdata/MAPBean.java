...
public class MAPBean {
	...
	public String getCarbootPlant() {
		return carbootPlant;
	}

	public void setCarbootPlant(String carbootPlant) {
		this.carbootPlant = carbootPlant;
	}
	...
	public double getOriginalMap() {
		return originalMap;
	}

	public void setOriginalMap(double originalMap) {
