...
public class DivideCustomerQD {
	private PhxbasicController _controller;
	private String dataSource1 = "../../etc/exportSAP/qdsp.xlsx";
	private String dataSource2 = "../../etc/exportSAP/qddebtors.xlsx";
	
	private String target = "../../var/exportSAP/deleteCustomer_out.xlsx";
	private String rows = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
	
	public static void main(String[] args) {
		DivideCustomerQD batch = new DivideCustomerQD();
		batch.init();
